...
def initialize_monitoring(secret_key,tracking_server_url, monitored_apps,rate_limit_threshold, tags=None):
    """
    ...
    """
    APIMonitorConfig.initialize(secret_key,tracking_server_url, monitored_apps,rate_limit_threshold, tags)
